...
public class UserService implements UserServiceInt{
    ...
    public void deleteUser(String userEmail) {
        Optional<UserEntity> user=userRepoInt.findByEmail(userEmail);
        user.ifPresent(uzer->verificationTokenService.deleteUserToken(uzer.getEmail()));
        userRepoInt.deleteByEmail(userEmail);
    }
